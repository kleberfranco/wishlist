...
router.get('/customer/:id', auth.authenticateToken,
    customerController.listCustomer);
router.put('/customer/:id', auth.authenticateToken, customerController.update);
router.delete('/customer/:id', auth.authenticateToken,
    customerController.delete);
router.post('/customer/:id/wishlist', auth.authenticateToken,
    customerController.createWishlist);
router.get('/customer/:id/wishlist', auth.authenticateToken,
    customerController.listWishlist);

router.get('/wishlists', auth.authenticateToken, wishlistController.list);
router.get('/wishlist/:id', auth.authenticateToken,
    wishlistController.listWishlist);
router.delete('/wishlist/:id', auth.authenticateToken,
