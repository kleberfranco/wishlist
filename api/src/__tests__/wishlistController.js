...
describe('wishlistController Test', () => {
  it('wishlistController: list all wishlists (without register)',
      function(done) {
  ...
  it('wishlistController: should require authorization (create new wishlist)',
      function(done) {
        request.post('/customer/' + customerId + '/wishlist').
            set('Content-Type', 'application/json').
            expect(401).
            end(function(err, res) {
              if (err) return done(err);
  ...
  it('wishlistController: should require valid fields (create new wishlist)',
      function(done) {
        request.post('/customer/' + customerId + '/wishlist').
            set('Authorization', `Bearer ${token}`).
            set('Content-Type', 'application/json').
  ...
  it('wishlistController: should require valid product (create new wishlist)',
      function(done) {
        request.post('/customer/' + customerId + '/wishlist').
            set('Authorization', `Bearer ${token}`).
            set('Content-Type', 'application/json').
  ...
  it('wishlistController: should require valid customer (create new wishlist)',
      function(done) {
        request.post('/customer/9999999999999/wishlist').
            set('Authorization', `Bearer ${token}`).
            set('Content-Type', 'application/json').
            send({
              products: ['1ss'],
  ...
  it('wishlistController: should require authorization (list all wishlists)',
      function(done) {
        request.get('/wishlists').
            set('Content-Type', 'application/json').
            expect(401).
  ...
  it('wishlistController: list all wishlists (limit and page)', function(done) {
    request.get('/wishlists?page=1&limit=1').
        set('Content-Type', 'application/json').
        set('Authorization', `Bearer ${token}`).
        expect(200).
        end(function(err, res) {
  ...
  it('wishlistController: should require authorization (get wishlist)',
      function(done) {
        request.get('/wishlist/' + wishlistId).
            set('Content-Type', 'application/json').
            expect(401).
            end(function(err, res) {
              if (err) return done(err);
  ...
  it('wishlistController: get wishlist (not found)', function(done) {
    request.get('/wishlist/999999999999999999999').
        set('Authorization', `Bearer ${token}`).
        set('Content-Type', 'application/json').
        expect(404).
        end(function(err, res) {
  ...
  it('wishlistController: should require authorization (delete wishlist)',
      function(done) {
